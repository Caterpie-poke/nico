...
contract c_00450052004300320030306b57fa3065304f30c830fc30af30f3306b95a23059308b59517d04 {
    ...
    string internal v_30c830fc30af30f3540d;    /*トークンの名称*/
    ...
    @param v_63075b9a65875b57 トークンの名称として指定する文字
    */
    constructor(int256 v_63075b9a5024, string memory v_63075b9a65875b57) public {
        v_7dcf767a884c91cf = v_63075b9a5024.mul(int256(10)).exp(int256(18));
        v_30c830fc30af30f3540d = v_63075b9a65875b57;
    ...
    */
    ...
    /*
    @function f_30c830fc30af30f3540d306e78ba8a8d トークン名の確認
    @return v_30c830fc30af30f3540d トークンの名称
    */
    function f_30c830fc30af30f3540d306e78ba8a8d() public view returns(string memory){
        return (v_30c830fc30af30f3540d);
    }
    ...
    */
    function f_900191d1(address v_900191d15148, int256 v_900191d1984d) public {
        require(v_900191d1984d >= int256(0));
    ...
    */
    function f_7b2c00338005306b3088308b900191d1306e8a3153ef(address v_900191d18005, int256 v_8a3153ef984d) public {
        require(v_8a3153ef984d >= int256(0));
