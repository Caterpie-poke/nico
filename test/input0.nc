...
第3条　安全な送付（safeTransferFrom）
    入力：
        ...
        送付トークンID
    要件：
        あなた＝送付トークンIDの所有者　または　あなた＝送付トークンIDの操作可能者　または　送付元のトークンに対してあなたが操作可能かどうか＝はい
    ...
    本文：
        ...
        送付元の持つトークン数を送付元の持つトークン数-1とする
        送付トークンIDの所有者を送付先とする
        送付先の持つトークン数を送付先の持つトークン数＋1とする
...
第4条　第3者からの送付（transferFrom）
    入力：
        ...
        送付トークンID
    要件：
        あなた＝送付トークンIDの所有者　または　あなた＝送付トークンIDの操作可能者　または　送付先のトークンに対してあなたが操作可能かどうか＝はい
        送付トークンIDの所有者 NOT= 0x0
        送付トークンIDの所有者＝送付元
        送付先 NOT= 0x0
        送付元の持つトークン数 ＞ 0
...
第5条　特定トークンの操作権の付与（approve）
    入力：
        ...
        対象トークンID
    要件：
        あなた＝対象トークンIDの所有者　または　あなた＝対象トークンIDの操作可能者　または　送付元のトークンに対してあなたが操作可能かどうか＝はい
...
第6条　所有する全トークンの操作権の付与（setApprovalForAll）
    ...
    要件：
        付与対象者 NOT= 0x0
    本文：
        あなたのトークンに対して付与対象者が操作可能かどうかを許可もしくは不許可とする
        SOL{emit ApprovalForAll(「あなた」,「付与対象者」,「許可もしくは不許可」)}
